<div class="favpress-field favpress-textarea" data-favpress-type="favpress-textarea">
	<div class="label">
		<label>
			<?php _e('Import', '__PLUGIN_SLUG__') ?>
		</label>
		<div class="description">
			<p><?php _e('Import Options', '__PLUGIN_SLUG__') ?></p>
		</div>
	</div>
	<div class="field">
		<div class="input">
			...
			<div class="buttons">
				<input id="favpress-js-import" class="favpress-button button" type="button" value="<?php _e('Import', '__PLUGIN_SLUG__') ?>" />
...
<div class="favpress-field favpress-textarea" data-favpress-type="favpress-textarea">
	<div class="label">
		<label>
			<?php _e('Export', '__PLUGIN_SLUG__') ?>
		</label>
		<div class="description">
			<p><?php _e('Export Options', '__PLUGIN_SLUG__') ?></p>
		</div>
	</div>
	<div class="field">
		<div class="input">
			...
			<div class="buttons">
				<input id="favpress-js-export" class="favpress-button button" type="button" value="<?php _e('Export', '__PLUGIN_SLUG__') ?>" />
				<span style="margin-left: 10px;">
