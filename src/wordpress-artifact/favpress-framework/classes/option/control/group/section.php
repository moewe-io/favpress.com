...
class FavPress_Option_Control_Group_Section extends FavPress_Option_Control_Group
{

	/**
	 * Collection of fields
	 * @var FavPress_Control_Field
	 */	
	private $_fields;
	...
	public function render($extra = array())
	{
		...
		return FavPress_View::instance()->load('option/section', $this->get_data());
	}
