...
class FavPress_Option_Depsloader
{

	/**
	 * The FavPress_Option_Set object!
	 */
	private $things;
	...
	public function build()
	{
		...
		$result['scripts'] = FavPress_Util_Config::instance()->load('dependencies', 'scripts.always');
		$result['styles']  = FavPress_Util_Config::instance()->load('dependencies', 'styles.always');

		$scripts = FavPress_Util_Config::instance()->load('dependencies', 'scripts.paths');
		$styles  = FavPress_Util_Config::instance()->load('dependencies', 'styles.paths');
	...
	public function can_output($hook_suffix = '')
	{
		...
		$menu_page_slug = FavPress_Util_Config::instance()->load('option', 'menu_page_slug');
