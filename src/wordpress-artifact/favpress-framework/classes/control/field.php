...
abstract class FavPress_Control_Field implements FavPress_iFactory
{
	...
	protected function _setup_data()
	{
		...
		// Determine Type
		$type = 'favpress-' . strtolower(substr(get_class($this), strrpos(get_class($this), '_') + 1));

		// Is hidden
		if($this->is_hidden())
		{
			$this->add_container_extra_classes('favpress-hide');
		}
		...
		$this->add_data('head_info', array(
			...
			'description'             => FavPress_Util_Text::parse_md($this->get_description())
		));
	}
	 ...
	 * @return FavPress_Control_Field Field object
	 */
