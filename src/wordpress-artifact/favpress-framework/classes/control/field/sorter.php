...
class FavPress_Control_Field_Sorter extends FavPress_Control_FieldMulti implements FavPress_MultiSelectable
{
	...
	public function render($is_compact = false)
	{
		...
		return FavPress_View::instance()->load('control/sorter', $this->get_data());
	}
