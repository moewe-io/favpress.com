...
class FavPress_WP_Loader
{
	...
	{
		$this->_dependencies = apply_filters( 'favpress_dependencies_array', FavPress_Util_Config::instance()->load('dependencies') );
		$this->_types        = array(
			'option'             => array(),
			'metabox'            => array(),
	...
	public function build()
	{
		...
		do_action( 'favpress_after_dependencies_loader_build' );
	...
	private function build_localize_data()
	{
		...
		$localize = array(
			...
			'public_url'               => FAVPRESS_PUBLIC_URL,
			'wp_include_url'           => includes_url(),
			'nonce'                    => wp_create_nonce( 'favpress' ),
			'val_msg'                  => $messages['validation'],
			'util_msg'                 => $messages['util'],
			'ctrl_msg'                 => $messages['control'],
			// validatable data
			'alphabet_validatable'     => apply_filters( 'favpress_alphabet_validatable'    , array( 'favpress-textbox', 'favpress-textarea' ) ),
			'alphanumeric_validatable' => apply_filters( 'favpress_alphanumeric_validatable', array( 'favpress-textbox', 'favpress-textarea' ) ),
			'numeric_validatable'      => apply_filters( 'favpress_numeric_validatable'     , array( 'favpress-textbox', 'favpress-textarea' ) ),
			'email_validatable'        => apply_filters( 'favpress_email_validatable'       , array( 'favpress-textbox', 'favpress-textarea' ) ),
			'url_validatable'          => apply_filters( 'favpress_url_validatable'         , array( 'favpress-textbox', 'favpress-textarea' ) ),
			'maxlength_validatable'    => apply_filters( 'favpress_maxlength_validatable'   , array( 'favpress-toggle', 'favpress-radiobutton', 'favpress-radioimage', 'favpress-select' ) ),
			'minlength_validatable'    => apply_filters( 'favpress_minlength_validatable'   , array( 'favpress-toggle', 'favpress-radiobutton', 'favpress-radioimage', 'favpress-select' ) ),
		);
