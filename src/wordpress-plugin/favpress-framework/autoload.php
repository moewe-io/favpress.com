...
| Register AutoLoader
|--------------------------------------------------------------------------
| Fafpress Framework has separated app and core directories, developers can
...
*/
FavPress_AutoLoader::add_namespaces(FAVPRESS_NAMESPACE);
FavPress_AutoLoader::add_directories(FAVPRESS_CLASSES_DIR, FAVPRESS_NAMESPACE);
FavPress_AutoLoader::register();

class FavPress_AutoLoader
{
	/**
	 * Indicates if FavPress_AutoLoader has been registered.
	 * 
	 * @var boolean
	 */
	...
	public static function register()
	{
		...
		{
			spl_autoload_register(array('FavPress_AutoLoader', 'load'));
		}
	...
	public static function add_namespaces($namespaces)
	{
		...
		usort(self::$namespaces, array('FavPress_AutoLoader', 'sort'));
	}
