...
class FavPress_WP_Enqueuer
{
	...
	public function __construct()
	{
		...
		add_action('favpress_loader_register_' . $this->_id, array($loader, 'register'), 10, 2);
	}
	...
	{
		do_action('favpress_loader_register_' . $this->_id, $this->_loaders, $hook_suffix);
	}
