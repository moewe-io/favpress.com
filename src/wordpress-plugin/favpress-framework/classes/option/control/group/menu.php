...
class FavPress_Option_Control_Group_Menu extends FavPress_Option_Control_Group
{

	/**
	 * Collection of $_menu
	 * @var FavPress_Option_Control_Group
	 */	
	private $_menus;
	...
	public function render($extra = array())
	{
		...
		return FavPress_View::instance()->load('option/menu', $this->get_data());
	}
